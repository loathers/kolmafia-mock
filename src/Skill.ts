...
type SkillObject = Omit<NonNullable<NonNullable<typeof skills>["nodes"][0]>, "nodeId" | "__typename">;

export class Skill {
  #skill: SkillObject;

  static none = new Skill({ id: -1, name: "", image: "", mpCost: 0, duration: 0, guildLevel: 0, maxLevel: 0, permable: false, ambiguous: false });
